...
const Chatbot = () => {
  ...
  const sendMessage = async () => {
    ...
    const userMessage = `You are a chatbot which only answers in paragraphs. Do not use bullet points or nay kind of formatting. Answer in plain paragraphs. for the formatting just  add para breaks wherever fit. like chnage paras that's all.  ${inputValue}`;
    ...
    try {
      const response = await axios({
        url: "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=AIzaSyAcP_0ss5bL607_kONd6ujecnayls1t9og",
        method: "post",
        data: {
          contents: [
            {
  ...
  const suggestions = [
    ...
    "Tell me what is Artificial Intelligence and NLP?",
  ];

  return (
    <div className="font-sans text-gray-100  flex items-center justify-center bg-gray">
